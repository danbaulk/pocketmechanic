...
import { PrintableHistory } from './components/PrintableHistory.tsx'
...
export function App() {
  ...
  return (
    <>
      {/* Screen UI — hidden while printing so only the service record prints. */}
      <div className="flex min-h-full flex-col bg-slate-50 print:hidden">
      ...
      {active && <PrintableHistory vehicle={active} />}
    </>
  )
}
